#!/usr/bin/env python3
"""Module that contains the WGAN_GP class."""
...
class WGAN_GP(keras.Model):
    ...
    def get_interpolated_sample(self, real_sample, fake_sample):
        """Generator of interpolating samples."""
    ...
    def replace_weights(self, gen_h5, disc_h5):
        ...
        Args:
            gen_h5 (str): Filepath to the generator's weights.
            disc_h5 (str): Filepath to the discriminator's weights.
        """
