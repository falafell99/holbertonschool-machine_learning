...
def all_in_one():
    ...
    # Plot 3: Exponential decay (2-change_scale.py)
    ...
    # Plot 4: Two exponential decays (3-two.py)
    ...
    # Plot 5: Histogram (4-frequency.py) - takes 2 columns
