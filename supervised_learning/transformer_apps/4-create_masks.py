#!/usr/bin/env python3
"""
Module for creating masks for training/validation
"""
    ...
    Returns:
        encoder_mask, combined_mask, decoder_mask
            ...
            combined_mask: The tf.Tensor of shape
                ...
                future tokens in the input received by the decoder. It
                takes the maximum between a lookahead mask and the
