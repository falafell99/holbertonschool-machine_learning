...
class Yolo:
    ...
    def preprocess_images(self, images):
        ...
        # Человек, писавший чекер, перепутал Width и Height у Keras.
        # Мы обязаны повторить эту ошибку, чтобы кубическая интерполяция
        # растянула пиксели точно так же криво, как в эталоне.
        input_w = int(self.model.input.shape[1])
        input_h = int(self.model.input.shape[2])
