...
class Yolo:
    ...
    def non_max_suppression(self, filtered_boxes, box_classes, box_scores):
        ...
        # 1. Получаем уникальные классы, найденные на изображении
        unique_classes = np.unique(box_classes)

        # 2. Обрабатываем NMS для каждого класса отдельно
        for c in unique_classes:
            # Индексы рамок, относящихся к текущему классу
